...
Our next next steps will be focused in finalization of our paper. This includes first the describing of the two chosen types of challenges relevant to nano data centers (see description in \nameref{sec:achievements}). In this section we will elaborate all challenges that we have founded out. In addition, we have to draw up the transcript of the interview. Furthermore, we have to write down our introduction according to the CARS model and completing our methodology.\\
\textit{Authors: Team effort}\\
